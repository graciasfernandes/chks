      ...
      <div class="row">
        <div class="col-md-7">
          <div  style="border-radius: 30px; "class="card">
            ...
            <a style="border-radius: 30px; padding: 7px;" href="../../"class="btn btn-success text-white float-left"><i class="fa fa-arrow-left"></i> Voltar</a>
              <h4>DEMON CENTER</h4>
              
              <textarea style="border-radius: 12px; background-color:  #17172a;padding:94px; "id="lista_ccs" class="form-control text-center form-checker mb-2" placeholder="Insira sua Lista"></textarea><br>
        ...
        <div class="col-md-5">
          <div style="border-radius: 30px; "class="card">
            <div class="card-body"><hr>
              <h5 class="title"></i> <span style="padding: 3px;"class="btn btn-success"> Aprovadas: </span> <span style="padding: 5px;border-radius: 60px;width:80px;" class="btn btn-secondary float-right"><i style="color:#14d5c4;"class="fa fa-check"> ㅤ </i> <b id="lives_ccs"> 00</b> </h5><hr>

              <h5 class="title"></i> <span style="padding: 3px;"class="btn btn-danger"> Reprovadas:</span> <span style="padding: 5px;border-radius: 60px;width: 80px;"class="btn badge-danger float-right "><i style="color:#d7678a;"class="fa fa-times"> ㅤ</i><b id="dies_ccs"> 00</b></span></h5><hr>

              <h5 class="title"></i> Testadas:<span style="padding: 5px;border-radius: 60px;width: 80px;"class="btn  float-right "><i style="color: #7749e7;"class="fa fa-spinner">ㅤ </i><b id="testado_ccs">  00</b></span></h5><hr>
           ...
           <!--   <h5 class="title"></i> Créditos:<span  style="padding: 5px; border-radius: 60px;width: 100px;" class="btn badge-info float-right creditos"><span class="text-success"> </span></span></h5><hr>-->
              ...
              <h5 class="title mb-0"></i> Carregadas:<span style="padding: 5px;border-radius: 60px;width: 80px;" class="btn badge-primary float-right "><i style="color: #7749e7;"class="fa fa-tasks ">ㅤ </i> <b id="total_ccs">00</b> </h5></span><br>
